...
<body class="bg-slate-50 antialiased font-sans flex items-center justify-center min-h-screen relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md p-6 text-center">
        ...
        <h1 class="text-9xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-600 leading-none">429</h1>
        <h2 class="text-2xl font-bold text-slate-800 mt-6">Terlalu Banyak Permintaan</h2>
        <p class="text-sm text-slate-500 mt-2.5 leading-relaxed max-w-sm mx-auto">
            Terlalu banyak percobaan masuk yang terdeteksi dari perangkat Anda. Silakan tunggu beberapa menit sebelum mencoba masuk kembali.
        </p>
